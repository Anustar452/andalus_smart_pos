{{-- // resources/views/admin/partials/sidebar-desktop.blade.php --}}
        ...
        <nav class="flex-1 px-2 pb-4 space-y-2">
            ...
            <a href="{{ route('admin.dashboard') }}" 
               class="group flex items-center px-2 py-2 text-sm font-medium rounded-md 
                ...
                <svg class="mr-3 h-6 w-6 {{ request()->routeIs('admin.dashboard') ? 'text-white' : 'text-blue-300' }}" 
            ...
            <a href="{{ route('admin.products') }}" 
               class="group flex items-center px-2 py-2 text-sm font-medium rounded-md 
                ...
                <svg class="mr-3 h-6 w-6 {{ request()->routeIs('admin.products') ? 'text-white' : 'text-blue-300' }}" 
                     fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
            ...
            <a href="/admin/categories" 
               class="group flex items-center px-2 py-2 text-sm font-medium rounded-md 
                ...
                <svg class="mr-3 h-6 w-6 {{ request()->routeIs('admin.categories') ? 'text-white' : 'text-blue-300' }}" 
                     fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
            ...
            <a href="{{ route('admin.transactions') }}" 
               class="group flex items-center px-2 py-2 text-sm font-medium rounded-md 
                ...
                <svg class="mr-3 h-6 w-6 {{ request()->routeIs('admin.transactions') ? 'text-white' : 'text-blue-300' }}" 
                     fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
            ...
            <a href="{{ route('admin.reports') }}" 
               class="group flex items-center px-2 py-2 text-sm font-medium rounded-md 
                ...
                <svg class="mr-3 h-6 w-6 {{ request()->routeIs('admin.reports') ? 'text-white' : 'text-blue-300' }}" 
                     fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
            ...
            <a href="/admin/users" 
               class="group flex items-center px-2 py-2 text-sm font-medium rounded-md 
                ...
                <svg class="mr-3 h-6 w-6 {{ request()->routeIs('admin.users') ? 'text-white' : 'text-blue-300' }}" 
                     fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
            ...
            <a href="/admin/settings" 
               class="group flex items-center px-2 py-2 text-sm font-medium rounded-md 
                ...
                <svg class="mr-3 h-6 w-6 {{ request()->routeIs('admin.settings') ? 'text-white' : 'text-blue-300' }}" 
                     fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
